      ...
      <b-row>
        <b-col cols="12">
          <b-card
            ...
            footer-tag="footer">
            <div slot="header">
              <i class="fa fa-align-justify"></i><strong> Add Product</strong>
              ...
              <b-col sm="6">
                <b-card>
                  ...
                  <div class="form-actions">
                    <b-button type="submit" variant="primary" v-on:click="submit()">Add New Product</b-button>
                  </div>
...
export default {
  ...
  methods: {
    ...
    userLink(_id) {
      return `addproduct/${_id.toString()}`;
    },
    rowClicked(item) {
